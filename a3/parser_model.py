...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        self.embed_to_hidden = nn.Linear(in_features=self.n_features*self.embed_size, out_features=self.hidden_size)
    ...
    def embedding_lookup(self, t):
        ...
        batch_size, n_features, embedding_size = embedding.size()
        x = embedding.view(batch_size, n_features * embedding_size)
        # END YOUR CODE
        return x
