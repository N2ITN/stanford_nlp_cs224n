...
def naiveSoftmaxLossAndGradient(
    ...
    print('softmax', np.dot(centerWordVec, outsideVectors.T), centerWordVec, outsideVectors.T, y_hat, sep='\n\n')
    delta = y_hat.copy()
...
def skipgram(currentCenterWord, windowSize, outsideWords, word2Ind,
    ...
    print(centerWordVectors,outsideVectors,word2Ind,outsideWords,sep='\n\n')
    ### YOUR CODE HERE
